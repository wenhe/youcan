...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    public function __construct()
    {
        ...
        $this->setTemplateDir( VIEWS. 'templates' . DS)
            ->setCompileDir(VIEWS . 'runtime' . DS)
            ->setPluginsDir(array(SMARTY_PLUGINS_DIR,LIBS . 'plugins' . DS))
            ->setCacheDir(VIEWS. 'cache' . DS)
            ->setConfigDir(LIBS . 'configs' . DS);
